          ...
          <div class="items">
            <div class="product">
              <div class="row">
                ...
                <!-- product  name,description,seller,freeDelivery,deliveryIn,features start -->
                <div class="col-md-6">
                  <div class="info">
                    <div class="row">
                ...
                <!-- product  name,description,seller,freeDelivery,deliveryIn,features end -->



                <!-- product  price and Quantity data start -->
                <div class="col-md-3">
                  <div class="row info">
                ...
                <!-- product  price and Quantity data end -->
